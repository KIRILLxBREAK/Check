...
private:
    ...
    std::vector<std::string> checkFile(std::string file_name);
    std::vector<std::string> checkTwoLine(std::string strline, std::string prevline, int line);
    std::vector<std::string> checkOneLine(std::string strline, int line);
};
